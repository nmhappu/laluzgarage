    ...
    >
      <div className="divide-y divide-workshop-border/30 border-b border-workshop-border/20">
        ...
        <div className="py-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <span className="text-xs font-bold font-numeric text-workshop-muted bg-workshop-surface px-3.5 py-2 rounded-lg border border-workshop-border/40">
            {WORKSHOP_DETAILS.currency} ({WORKSHOP_DETAILS.currencySymbol})
          </span>
        </div>
